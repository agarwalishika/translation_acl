...
SEED = 1234
CSV_PATH = "petci_chinese_english_improved.csv"
MODEL_ID = "Qwen/Qwen2.5-3B-Instruct"

NUM_EPOCHS = 3
BATCH_SIZE = 2
NUM_SAMPLES_PER_SRC = 4
LR = 5e-6
WD = 1e-2
GRAD_CLIP_NORM = 0.5
MAX_NEW_TOKENS = 96
...
USE_DRIVE = False
DRIVE_DIR = "/content/drive/MyDrive/GRPO-Chinese-Eng/qwen2.5-3b-grpo-comet-da-v3"
LOCAL_DIR = "/qwen2.5-3b-grpo-comet-da-v3"
...
test_df  = df.iloc[perm[mid:]].reset_index(drop=True)
